// src/app/urunler/kagit/pamuklu-kanvas-cotton/PamukluKanvasCottonClient.tsx
"use client";
...
type Variant = {
  widthCm: number;   // en (cm) -> 91.4 => "914cm" formatı
  lengthM: number;   // mt
  gram: number;      // 380
...
const IMG = {
  ...
  alt: "Pamuklu kanvas (cotton) rulo",
};

const VARIANTS: Variant[] = [
  { widthCm: 62, lengthM: 18, gram: 380, brand: "Papirink", origin: "Yerli", packaging: "Rulo" },
  { widthCm: 107, lengthM: 18, gram: 380, brand: "Papirink", origin: "Yerli", packaging: "Rulo" },
  { widthCm: 112, lengthM: 30, gram: 380, brand: "Papirink", origin: "Yerli", packaging: "Rulo" },
  { widthCm: 152, lengthM: 18, gram: 380, brand: "Papirink", origin: "Yerli", packaging: "Rulo" },
  { widthCm: 91.4, lengthM: 18, gram: 380, brand: "Papirink", origin: "Yerli", packaging: "Rulo" }, // 914cm
];
...
function fmtTitle(v: Variant) {
  return `${fmtWidth(v.widthCm)}*${v.lengthM}mt Cotton Kanvas ${v.gram} gr`;
}
...
export default function PamukluKanvasCottonClient({ contactHref = "/iletisim" }: Props) {
  ...
  }, [filterLen, filterWidth, filterGram]);
          ...
          <div className="grid gap-8 md:grid-cols-2 md:items-center">
            ...
            <div className="space-y-4">
              <h1 className="text-2xl font-semibold tracking-tight text-gray-900">
                Pamuklu Kanvas (Cotton) • 380 gr
              </h1>

              <p className="text-sm text-gray-600">
                Papirink pamuklu kanvas (cotton) seçenekleri: farklı en ve uzunluk alternatifleri ile.
              </p>
              ...
              <div className="rounded-2xl border bg-white p-5">
                <div className="grid gap-3 text-sm">
                  ...
                  <Row k="Gramaj" v="380 gr" />
                  <Row k="Ürün Tipi" v="Cotton Kanvas" />
                </div>
              </div>
      ...
      <section className="mx-auto max-w-6xl px-4 py-10">
        <div className="mb-5 flex flex-col gap-3 (sm:flex-row sm:items-center sm:justify-between)">
          <div>
            ...
            <p className="text-sm text-gray-600">
              En, uzunluk ve gramaj filtreleriyle hızlı seçim yapın.
            </p>
          </div>
        ...
        <div className="overflow-hidden rounded-2xl border">
          ...
          <div className="divide-y">
            {filtered.map((v, idx) => (
              <div
                key={`${v.widthCm}-${v.lengthM}-${v.gram}-${idx}`}
              ...
              >
                <div className="col-span-12 sm:col-span-6">
                  ...
                  <div className="mt-1 text-xs text-gray-500">
                    Ambalaj: {v.packaging} • Menşei: {v.origin} • Marka: {v.brand}
                  </div>
                </div>

                <div className="col-span-4 sm:col-span-2 text-sm text-gray-700">{fmtWidth(v.widthCm)}</div>
