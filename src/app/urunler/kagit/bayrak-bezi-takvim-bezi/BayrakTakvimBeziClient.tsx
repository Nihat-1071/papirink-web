// src/app/urunler/kagit/bayrak-bezi-takvim-bezi/BayrakTakvimBeziClient.tsx
"use client";
...
const IMG = {
  ...
  alt: "Bayrak bezi takvim bezi kırlangıç bezi rulo",
};

const VARIANTS: Variant[] = [
  { widthCm: 107, lengthM: 50, gram: 125, brand: "Papirink", origin: "Yerli", packaging: "Rulo" },
  { widthCm: 152, lengthM: 50, gram: 125, brand: "Papirink", origin: "Yerli", packaging: "Rulo" },
];
...
function fmtTitle(v: Variant) {
  return `${fmtWidth(v.widthCm)}*${v.lengthM}mt Bayrak-Takvim-Kırlangıç Bezi ${v.gram} gr`;
}
...
export default function BayrakTakvimBeziClient({ contactHref = "/iletisim" }: Props) {
          ...
          <div className="grid gap-8 md:grid-cols-2 md:items-center">
            ...
            <div className="space-y-4">
              <h1 className="text-2xl font-semibold tracking-tight text-gray-900">
                Bayrak Bezi • Takvim Bezi • Kırlangıç Bezi
              </h1>
              <p className="text-sm text-gray-600">
                125 gr rulo seçenekleri: 107cm*50mt ve 152cm*50mt. Teklif için iletişime geçin.
              </p>
      ...
      <section className="mx-auto max-w-6xl px-4 py-10">
        <div className="mb-5 flex flex-col gap-3 sm:flex-row sm:items-center sm:justify-between">
          <div>
            ...
            <p className="text-sm text-gray-600">En filtresiyle hızlı seçim yapın.</p>
          </div>
        ...
        <div className="overflow-hidden rounded-2xl border">
          <div className="grid grid-cols-12 bg-gray-50 px-4 py-3 text-xs font-semibold text-gray-700">
            ...
            <div className="col-span-1">Menşei</div>
          ...
          <div className="divide-y">
            {filtered.map((v, idx) => (
              ...
              >
                ...
                <div className="col-span-4 sm:col-span-2 text-sm text-gray-700">{v.gram}</div>
                <div className="col-span-4 sm:col-span-1 text-sm text-gray-700">{v.origin}</div>
