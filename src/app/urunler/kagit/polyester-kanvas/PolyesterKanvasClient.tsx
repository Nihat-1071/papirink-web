...
const IMG = {
  ...
  alt: "Polyester kanvas rulo",
};

const VARIANTS: Variant[] = [
  { widthCm: 107, lengthM: 30, gram: 230, brand: "Papirink", origin: "Yerli", packaging: "Rulo / Paket" },
  { widthCm: 112, lengthM: 30, gram: 230, brand: "Papirink", origin: "Yerli", packaging: "Rulo / Paket" },
  { widthCm: 112, lengthM: 30, gram: 260, brand: "Papirink", origin: "Yerli", packaging: "Rulo / Paket" },
  { widthCm: 152, lengthM: 30, gram: 230, brand: "Papirink", origin: "Yerli", packaging: "Rulo / Paket" },
  { widthCm: 62,  lengthM: 30, gram: 230, brand: "Papirink", origin: "Yerli", packaging: "Rulo / Paket" },
  { widthCm: 76,  lengthM: 30, gram: 230, brand: "Papirink", origin: "Yerli", packaging: "Rulo / Paket" },
  { widthCm: 91.4, lengthM: 30, gram: 230, brand: "Papirink", origin: "Yerli", packaging: "Rulo / Paket" },
];
...
function fmtTitle(v: Variant) {
  return `${fmtWidth(v.widthCm)}*${v.lengthM}mt Polyester Kanvas ${v.gram} gr`;
}
...
export default function PolyesterKanvasClient({ contactHref = "/iletisim" }: Props) {
          ...
          <div className="grid gap-8 md:grid-cols-2 md:items-center">
            ...
            <div className="space-y-4">
              <h1 className="text-2xl font-semibold tracking-tight text-gray-900">
                Polyester Kanvas • 30 mt
              </h1>
              <p className="text-sm text-gray-600">
                Kanvas baskılar için polyester tabanlı rulo seçenekleri. Farklı en ve gramaj alternatifleriyle.
              </p>
