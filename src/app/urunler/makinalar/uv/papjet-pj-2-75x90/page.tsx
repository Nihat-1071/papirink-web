...
const pagePath = "/urunler/makinalar/uv/papjet-pj-2-75x90";

export const metadata: Metadata = {
  title: "Papjet PJ-2 75x90 UV Baskı Makinası | Papirink",
  description:
    "Papjet PJ-2 75x90 UV baskı makinası: 75×90 cm baskı alanı, 10 cm baskı yüksekliği, 64 m²/saat hız, Ricoh GH2220 baskı kafası ve LED UV kurutma teknolojisi.",
  alternates: { canonical: `${baseUrl}${pagePath}` },
};

const product = {
  title: "Papjet PJ-2 75x90 UV",
  brand: "Papirink",
  category: "UV Baskı Makinası",
  image: "/images/urunler/makinalar/uv/papjet-pj-2-75x90-uv.jpg",

  description: `Papjet PJ-2 75x90 UV baskı makinası; daha geniş baskı alanı, daha yüksek taşıma kapasitesi ve gelişmiş baskı teknolojileri ile profesyonel üretim ihtiyaçları için tasarlanmıştır.

75 × 90 cm baskı alanı ve 10 cm’ye kadar baskı yüksekliği sayesinde kalın ve farklı yüzeyli malzemelerde rahatlıkla baskı alınabilir. Güçlü vakum emiş sistemi ve Ricoh GH2220 baskı kafası teknolojisi ile yüksek çözünürlükte, keskin ve uzun ömürlü baskılar elde edilir.

Yeni nesil LED UV kurutma sistemi düşük enerji tüketimi sağlarken; otomatik malzeme yüksekliği ölçümü, negatif basınç mürekkep sistemi ve beyaz mürekkep donma önleyici yapısı ile üretim sürekliliğini artırır. Reklam, promosyon ve endüstriyel baskı alanlarında geniş kullanım sunar.`,

  specs: [
    { k: "Baskı Alanı", v: "75 × 90 cm" },
    { k: "Baskı Yüksekliği", v: "10 cm’ye kadar" },
    { k: "Üretim Hızı", v: "64 m² / saat" },
    { k: "Vakum Sistemi", v: "Yüksek vakum emiş gücü" },
    { k: "Baskı Kafası", v: "3 – 8 adet baskı kafası opsiyonu" },
    {
      k: "Çözünürlük",
      v: "1600 × 1440 dpi • 3 pt yazı baskı kabiliyeti",
    },
    {
      k: "Kafa Teknolojisi",
