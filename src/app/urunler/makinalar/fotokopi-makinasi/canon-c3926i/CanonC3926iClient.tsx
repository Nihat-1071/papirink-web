...
export default function CanonC3926iClient() {
  ...
  const specsImage =
    "/images/urunler/makinalar/fotokopi-makinasi/canon-c3926i-fotokopi-makinasi-ozellikleri.webp";

  const bullets: string[] = [
    "Dakikada 26 kopya",
    "Çift taraf baskı, fotokopi ve tarama",
    "USB ve Ethernet erişim",
    "Siyah 38.000 / Renkli 25.500 toner kapasitesi",
    "256GB harddisk",
  ];

  const quickSpecs: SpecItem[] = [
    { label: "Model", value: "Canon c3926i" },
    { label: "Hız", value: "26 kopya/dk" },
    { label: "Bağlantı", value: "USB / Ethernet (WiFi opsiyonel)" },
    { label: "Baskı", value: "300 grama kadar" },
    { label: "Kullanım", value: "Yoğun ofis / kurumsal" },
  ];
        ...
        <div className="grid gap-8 lg:grid-cols-2 lg:items-center">
          ...
          <div>
            ...
            <p className="mt-3 max-w-xl text-slate-600 leading-relaxed">
              A3 renkli çok fonksiyonlu fotokopi makinası. Yüksek toner kapasitesi ve
              kurumsal iş yükleri için güçlü, stabil ve uzun ömürlü çözüm.
            </p>
