// src/app/urunler/kartus/hp-orjinal-kartus/hp-728/Hp728Client.tsx
"use client";
...
const COMPATIBLE_MODELS_HP728: string[] = [
  "HP DesignJet T830 24 inç Çok İşlevli Yazıcı (F9A28A)",
  "HP DesignJet T730 914mm Yazıcı (F9A29A)",
  "HP DesignJet T830 36 inç Çok İşlevli Yazıcı (F9A30A)",
  "HP DesignJet T830 MFP ile koruma kılıfı (Wi-Fi yok) (1JL02B)",
];

const ITEMS: Hp728Item[] = [
  {
    title: "HP 728 300 ml Sarı Orjinal Kartuş (F9K15A)",
    code: "F9K15A",
    ...
    image: {
      ...
      alt: "HP 728 300 ml Sarı Orjinal Kartuş (F9K15A)",
    },
    compatibleModels: COMPATIBLE_MODELS_HP728,
  },
  {
    title: "HP 728 300 ml Mat Siyah Orjinal Kartuş (F9J68A)",
    code: "F9J68A",
    ...
    image: {
      ...
      alt: "HP 728 300 ml Mat Siyah Orjinal Kartuş (F9J68A)",
    },
    compatibleModels: COMPATIBLE_MODELS_HP728,
  },
  {
    title: "HP 728 300 ml Cam Göbeği Orjinal Kartuş (F9J67A)",
    code: "F9J67A",
    colorLabel: "Cam Göbeği (Cyan)",
    capacity: "300 ml",
    image: {
      src: "/images/urunler/kartus/hp-orjinal-kartus/hp-728-orijinal-cam-gobegi-murekkep-kartusu-f9j67a.jpg",
      alt: "HP 728 300 ml Cam Göbeği Orjinal Kartuş (F9J67A)",
    },
    compatibleModels: COMPATIBLE_MODELS_HP728,
  },
    {
    title: "HP 728 F9K17A Mavi Orjinal Kartuş 300 ml",
    code: "F9K17A",
    colorLabel: "Mavi (Cyan)",
    capacity: "300 ml",
    image: {
      src: "/images/urunler/kartus/hp-orjinal-kartus/hp-728-f9k17a-orijinal-mavi-kartus.jpg",
      alt: "HP 728 F9K17A Mavi Orjinal Kartuş 300 ml",
    },
    compatibleModels: COMPATIBLE_MODELS_HP728,
  },
];
...
export default function Hp728Client() {
      ...
      <div className="mt-10 grid gap-6 lg:grid-cols-3">
        ...
        <div className="rounded-xl border border-slate-200 bg-white p-5">
          ...
          <div className="mt-4 grid gap-3">
            ...
            <InfoRow label="Seri" value="HP 728" />
