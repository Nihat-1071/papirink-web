// src/app/urunler/kartus/hp-orijinal-kartus/Hp711Client.tsx
"use client";
...
const ITEMS: Hp711Item[] = [
  {
    title: "HP 711 C1Q10A Baskı Kafası Değiştirme Takımı",
    code: "C1Q10A",
    colorLabel: "Baskı Kafası (Set)",
    capacity: "Baskı kafası seti",
    image: {
    ...
    compatibleModels: ["HP Designjet T120", "HP Designjet T520"],
    notes: ["Baskı kafası seti / takım (kartuş değildir)."],
  },
  {
    title: "HP 711 CZ130A Mavi Orijinal Kartuş",
    code: "CZ130A",
  ...
  {
    title: "HP 711 CZ131A Kırmızı Orijinal Kartuş",
    code: "CZ131A",
  ...
  {
    title: "HP 711 CZ133A Siyah Orijinal Kartuş",
    code: "CZ133A",
    ...
    image: {
      ...
      alt: "HP 711 CZ133A Siyah Orijinal Kartuş",
    },
    compatibleModels: ["HP Designjet T120", "HP Designjet T520"],
  },
];
...
export default function Hp711Client() {
    ...
    <>
      ...
      <div className="mt-10 grid gap-6 lg:grid-cols-3">
        ...
        <div className="rounded-xl border border-slate-200 bg-white p-5">
          ...
          {/* Başlıkta T120/T520 yok (kuralına göre) */}
          ...
          <div className="mt-4 grid gap-3">
            ...
            <InfoRow label="Seri" value="HP 711" />
        ...
        {/* SAĞ: Ürün açıklaması (DÜZ METİN BLOK) */}
        <div className="rounded-xl border border-slate-200 bg-white p-5">
          ...
          <div className="mt-4 rounded-xl border border-slate-200 bg-white">
            <div className="grid grid-cols-1 divide-y divide-slate-200">
              ...
              <BoxRow label="Marka" value="HP" />
              <BoxRow label="Baskı Kapasitesi" value={active.capacity} />
              {/* T120/T520 sadece burada (kuralına göre) */}
              <BoxRow
                label="Yazıcı Modeli"
...
function BoxRow({ label, value }: { label: string; value: string }) {
  return (
    <div className="grid grid-cols-[140px_1fr] gap-4 p-4">
      ...
      {/* DÜZ METİN BLOK: yeni satırları koru */}
