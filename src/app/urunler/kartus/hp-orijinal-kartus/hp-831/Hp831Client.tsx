// src/app/urunler/kartus/hp-orjinal-kartus/hp-831/Hp831Client.tsx
"use client";
...
const COMPATIBLE_MODELS_HP831: string[] = [
  "HP Latex 310 Yazıcı (B4H69A)",
  "HP Latex 330 Yazıcı (E2X76A)",
  "HP Latex 360 Yazıcı (B4H70A)",
  "HP Latex 315 Yazıcı (V7L46A)",
  "HP Latex 335 Yazıcı (V7L47A)",
  "HP Latex 365 Yazıcı (V8L39A)",
  "HP Latex 370 Yazıcı (L4R41A)",
  "HP Latex 375 Printer (V8N83A)",
  "HP Latex 560 Yazıcı (M0E29A)",
  "HP Latex 570 Yazıcı (N2G70A)",
];

const ITEMS: Hp831Item[] = [
  {
    title: "HP 831C CZ694A Siyah Orjinal Lateks Kartuş",
    code: "CZ694A",
    colorLabel: "Siyah (Black)",
    capacity: "775 ml",
    image: {
      src: "/images/urunler/kartus/hp-orjinal-kartus/hp-831c-cz694a-siyah-orijinal-lateks-kartus.jpg",
      alt: "HP 831C CZ694A Siyah Orjinal Lateks Kartuş",
    },
    compatibleModels: COMPATIBLE_MODELS_HP831,
  },
  {
  ...
  {
    title: "HP 831C CZ696A Kırmızı Orjinal Lateks Kartuş",
    code: "CZ696A",
    colorLabel: "Kırmızı (Magenta)",
    capacity: "775 ml",
    image: {
      src: "/images/urunler/kartus/hp-orjinal-kartus/hp-831c-cz696a-kirmizi-orijinal-latex-kartus.jpg",
      alt: "HP 831C CZ696A Kırmızı Orjinal Lateks Kartuş",
    },
    compatibleModels: COMPATIBLE_MODELS_HP831,
  },
  {
    title: "HP 831C CZ697A Sarı Orjinal Lateks Kartuş",
    code: "CZ697A",
    colorLabel: "Sarı (Yellow)",
    capacity: "775 ml",
    image: {
      src: "/images/urunler/kartus/hp-orjinal-kartus/hp-831c-cz697a-sari-orijinal-latex-kartus.jpg",
      alt: "HP 831C CZ697A Sarı Orjinal Lateks Kartuş",
    },
    compatibleModels: COMPATIBLE_MODELS_HP831,
  },
  {
    title: "HP 831C CZ698A Açık Mavi Lateks Kartuş",
    code: "CZ698A",
  ...
  {
    title: "HP 831C CZ699A Açık Kırmızı Orjinal Lateks Kartuş",
    code: "CZ699A",
    ...
    image: {
      ...
      alt: "HP 831C CZ699A Açık Kırmızı Orjinal Lateks Kartuş",
    },
    compatibleModels: COMPATIBLE_MODELS_HP831,
  },
  {
    title: "HP 831C CZ706A Optimizer Lateks Kartuş",
    code: "CZ706A",
    colorLabel: "Optimizer",
    capacity: "775 ml",
    image: {
    ...
    compatibleModels: COMPATIBLE_MODELS_HP831,
    notes: [
      "Optimizer; bazı HP Latex yazıcılarda baskı kalitesi ve tutunma performansı için kullanılan yardımcı kartuş tipidir.",
    ],
  },
];
...
export default function Hp831Client() {
      ...
      <div className="mt-10 grid gap-6 lg:grid-cols-3">
        ...
        <div className="rounded-xl border border-slate-200 bg-white p-5">
          ...
          <div className="mt-4 grid gap-3">
            ...
            <InfoRow label="Seri" value="HP 831C" />
