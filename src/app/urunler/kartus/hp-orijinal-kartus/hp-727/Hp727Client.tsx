// src/app/urunler/kartus/hp-orjinal-kartus/hp-72/Hp72Client.tsx
"use client";
...
const COMPATIBLE_MODELS_HP72: string[] = [
  "HP Designjet T610 Yazıcı serisi",
  "HP Designjet T620 Yazıcı serisi",
  "HP Designjet T770 Yazıcı serisi",
  "HP Designjet T1100 Yazıcı serisi",
  "HP Designjet T1200 Yazıcı serisi",
  "HP Designjet T1200 HD Çok İşlevli Yazıcı",
...
const ITEMS: Hp72Item[] = [
  {
    title: "HP 72 Foto Siyah Mürekkep Kartuşu (C9370A)",
    code: "C9370A",
    ...
    compatibleModels: COMPATIBLE_MODELS_HP72,
  },
  {
    title: "HP 72 Mavi Mürekkep Kartuşu (C9371A)",
    code: "C9371A",
  ...
  {
    title: "HP 72 Kırmızı Mürekkep Kartuşu (C9372A)",
    code: "C9372A",
  ...
  {
    title: "HP 72 Sarı Mürekkep Kartuşu (C9373A)",
    code: "C9373A",
  ...
  {
    title: "HP 72 Gri Mürekkep Kartuşu (C9374A)",
    code: "C9374A",
    colorLabel: "Gri (Gray)",
    capacity: "130 ml",
    image: {
  ...
  {
    title: "HP 72 Mat Siyah Mürekkep Kartuşu (C9403A)",
    code: "C9403A",
