// src/app/urunler/kartus/hp-orjinal-kartus/hp-773/Hp773Client.tsx
"use client";
...
const COMPATIBLE_MODELS_HP773: string[] = [
  "HP DesignJet Z6600 1524-mm Production Printer (F2S71A)",
  "HP DesignJet Z6800 1524-mm Photo Production Printer (F2S72A)",
];

const ITEMS: Hp773Item[] = [
  {
    title: "HP 773C C1Q37A Mat Siyah Orjinal Kartuş - DesignJet Z6600 / Z6800",
    code: "C1Q37A",
    ...
    image: {
      ...
      alt: "HP 773C C1Q37A Mat Siyah Orjinal Kartuş - DesignJet Z6600 / Z6800",
    },
    compatibleModels: COMPATIBLE_MODELS_HP773,
  },
  {
    title:
      "HP 773C C1Q38A Kromatik Kırmızı Orjinal Kartuş - DesignJet Z6600 / Z6800",
    code: "C1Q38A",
    ...
    image: {
      ...
      alt: "HP 773C C1Q38A Kromatik Kırmızı Orjinal Kartuş - DesignJet Z6600 / Z6800",
    },
    compatibleModels: COMPATIBLE_MODELS_HP773,
    notes: ["* Bu kod için kapasite 750 ml olarak geçmektedir."],
  },
  {
    title: "HP 773C C1Q39A Kırmızı Orjinal Kartuş - DesignJet Z6600 / Z6800",
    code: "C1Q39A",
    ...
    image: {
      ...
      alt: "HP 773C C1Q39A Kırmızı Orjinal Kartuş - DesignJet Z6600 / Z6800",
    },
    compatibleModels: COMPATIBLE_MODELS_HP773,
  },
  {
    title: "HP 773C C1Q40A Sarı Orjinal Kartuş - DesignJet Z6600 / Z6800",
    code: "C1Q40A",
    ...
    image: {
      ...
      alt: "HP 773C C1Q40A Sarı Orjinal Kartuş - DesignJet Z6600 / Z6800",
    },
    compatibleModels: COMPATIBLE_MODELS_HP773,
  },
  {
    title:
      "HP 773C C1Q41A Açık Kırmızı Orjinal Kartuş - DesignJet Z6600 / Z6800",
    code: "C1Q41A",
    ...
    image: {
      ...
      alt: "HP 773C C1Q41A Açık Kırmızı Orjinal Kartuş - DesignJet Z6600 / Z6800",
    },
    compatibleModels: COMPATIBLE_MODELS_HP773,
  },
  {
    title: "HP 773C C1Q42A Mavi Orjinal Kartuş - DesignJet Z6600 / Z6800",
    code: "C1Q42A",
    ...
    image: {
      ...
      alt: "HP 773C C1Q42A Mavi Orjinal Kartuş - DesignJet Z6600 / Z6800",
    },
    compatibleModels: COMPATIBLE_MODELS_HP773,
  },
  {
    title: "HP 773C C1Q43A Foto Siyah Orjinal Kartuş - DesignJet Z6600 / Z6800",
    code: "C1Q43A",
    ...
    image: {
      ...
      alt: "HP 773C C1Q43A Foto Siyah Orjinal Kartuş - DesignJet Z6600 / Z6800",
    },
    compatibleModels: COMPATIBLE_MODELS_HP773,
  },
  {
    title:
      "HP 773C C1Q44A Açık Gri Orjinal Kartuş - DesignJet Z6600 / Z6800",
    code: "C1Q44A",
    ...
    image: {
      ...
      alt: "HP 773C C1Q44A Açık Gri Orjinal Kartuş - DesignJet Z6600 / Z6800",
    },
    compatibleModels: COMPATIBLE_MODELS_HP773,
  },
];
...
export default function Hp773Client() {
      ...
      <div className="mt-10 grid gap-6 lg:grid-cols-3">
        ...
        <div className="rounded-xl border border-slate-200 bg-white p-5">
          ...
          <div className="mt-4 grid gap-3">
            ...
            <InfoRow label="Seri" value="HP 773C" />
