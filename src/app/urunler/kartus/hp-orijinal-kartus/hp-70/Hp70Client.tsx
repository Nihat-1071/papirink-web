// src/app/urunler/kartus/hp-orjinal-kartus/hp-70/Hp70Client.tsx
"use client";
...
const COMPATIBLE_MODELS_HP70: string[] = [
  "HP DesignJet Z2100 24-In Orjinal Kartuş",
  "HP DesignJet Z2100 44-In Orjinal Kartuş",
  "HP DesignJet Z3100 24-In Orjinal Kartuş",
  "HP DesignJet Z3100 44-In Orjinal Kartuş",
  "HP DesignJet Z3100ps Gp 24-In Orjinal Kartuş",
  "HP DesignJet Z3100ps Gp 44-In Orjinal Kartuş",
  "HP DesignJet Z3200 24-In Orjinal Kartuş",
  "HP DesignJet Z3200 44-In Orjinal Kartuş",
  "HP DesignJet Z3200ps 24-In Orjinal Kartuş",
  "HP DesignJet Z3200ps 44-In Orjinal Kartuş",
  "HP DesignJet Z3200ps Gp 24-In Orjinal Kartuş",
  "HP DesignJet Z3200ps Gp 44-In Orjinal Kartuş",
  "HP DesignJet Z5200 PostScript Orjinal Kartuş",
  "HP DesignJet Z5400 PostScript Orjinal Kartuş",
];

const ITEMS: Hp70Item[] = [
  {
    title: "Hp 70-C9390A Açık Mavi Orjinal Kartuş",
    code: "C9390A",
    colorLabel: "Açık Mavi (Light Cyan)",
    capacity: "130 ml",
    image: {
      src: "/images/urunler/kartus/hp-orjinal-kartus/hp-70-c9390a-acik-mavi-orjinal-kartus.jpg",
      alt: "Hp 70-C9390A Açık Mavi Orjinal Kartuş",
    },
    compatibleModels: COMPATIBLE_MODELS_HP70,
  },
  {
    title: "Hp 70-C9448A Mat Siyah Orjinal Kartuş",
    code: "C9448A",
    colorLabel: "Mat Siyah (Matte Black)",
    capacity: "130 ml",
    image: {
      src: "/images/urunler/kartus/hp-orjinal-kartus/hp-70-c9448a-mat-siyah-orjinal-kartus.jpg",
      alt: "Hp 70-C9448A Mat Siyah Orjinal Kartuş",
    },
    compatibleModels: COMPATIBLE_MODELS_HP70,
  },
  {
    title: "Hp 70-C9449A Foto Siyah Orjinal Kartuş",
    code: "C9449A",
    colorLabel: "Foto Siyah (Photo Black)",
    capacity: "130 ml",
    image: {
      src: "/images/urunler/kartus/hp-orjinal-kartus/hp-70-c9449a-foto-siyah-orjinal-kartus.jpg",
      alt: "Hp 70-C9449A Foto Siyah Orjinal Kartuş",
    },
    compatibleModels: COMPATIBLE_MODELS_HP70,
  },
  {
    title: "Hp 70-C9451A Açık Gri Orjinal Kartuş",
    code: "C9451A",
    colorLabel: "Açık Gri (Light Gray)",
    capacity: "130 ml",
    image: {
      src: "/images/urunler/kartus/hp-orjinal-kartus/hp-70-c9451a-acik-gri-orjinal-kartus.jpg",
      alt: "Hp 70-C9451A Açık Gri Orjinal Kartuş",
    },
    compatibleModels: COMPATIBLE_MODELS_HP70,
  },
  {
    title: "Hp 70-C9453A Kırmızı Orjinal Kartuş",
    code: "C9453A",
    colorLabel: "Kırmızı (Magenta)",
    capacity: "130 ml",
    image: {
      src: "/images/urunler/kartus/hp-orjinal-kartus/hp-70-c9453a-kirmizi-orjinal-kartus.jpg",
      alt: "Hp 70-C9453A Kırmızı Orjinal Kartuş",
    },
    compatibleModels: COMPATIBLE_MODELS_HP70,
  },
  {
    title: "Hp 70-C9454A Sarı Orjinal Kartuş",
    code: "C9454A",
    colorLabel: "Sarı (Yellow)",
    capacity: "130 ml",
    image: {
      src: "/images/urunler/kartus/hp-orjinal-kartus/hp-70-c9454a-sari-orjinal-kartus.jpg",
      alt: "Hp 70-C9454A Sarı Orjinal Kartuş",
    },
    compatibleModels: COMPATIBLE_MODELS_HP70,
  },
  {
    title: "Hp 70-C9455A Açık Kırmızı Orjinal Kartuş",
    code: "C9455A",
    ...
    image: {
      ...
      alt: "Hp 70-C9455A Açık Kırmızı Orjinal Kartuş",
    },
    compatibleModels: COMPATIBLE_MODELS_HP70,
  },
  {
    title: "Hp 70-C9458A Mavi Orjinal Kartuş",
    code: "C9458A",
    colorLabel: "Mavi (Cyan)",
    capacity: "130 ml",
    image: {
      src: "/images/urunler/kartus/hp-orjinal-kartus/hp-70-c9458a-mavi-orjinal-kartus.jpg",
      alt: "Hp 70-C9458A Mavi Orjinal Kartuş",
    },
    compatibleModels: COMPATIBLE_MODELS_HP70,
  },
];
...
export default function Hp70Client() {
      ...
      <div className="mt-10 grid gap-6 lg:grid-cols-3">
        ...
        <div className="rounded-xl border border-slate-200 bg-white p-5">
          ...
          <div className="mt-4 grid gap-3">
            ...
            <InfoRow label="Seri" value="HP 70" />
