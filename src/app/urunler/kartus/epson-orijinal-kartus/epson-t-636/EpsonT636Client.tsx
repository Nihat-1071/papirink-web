// src/app/urunler/kartus/epson-orijinal-kartus/epson-t-636/EpsonT636Client.tsx
"use client";
...
const COMPATIBLE_MODELS = [
  ...
  "Epson Stylus Pro 9900 SpectroProofer",
  "Epson Stylus Pro WT7900",
];

const ITEMS: EpsonT636Item[] = [
  {
    title: "EPSON T6365 (C13T636500) Açık Mavi Kartuş",
    code: "T6365",
    colorLabel: "Açık Mavi (Light Cyan)",
    capacity: "700 ml",
    image: {
      src: "/images/urunler/kartus/epson-orijinal-kartus/epson-t6365-c13t636500-acik-mavi-kartus.jpg",
      alt: "EPSON T6365 (C13T636500) Açık Mavi Kartuş",
    },
    compatibleModels: COMPATIBLE_MODELS,
    notes: ["Kod karşılığı: C13T636500"],
  },
  {
    title: "EPSON T6366 Açık Kırmızı Orijinal Kartuş",
    code: "T6366",
    colorLabel: "Açık Kırmızı (Light Magenta)",
    capacity: "700 ml",
    image: {
      src: "/images/urunler/kartus/epson-orijinal-kartus/epson-t6366-acik-kirmizi-orijinal-kartus.jpg",
      alt: "EPSON T6366 Açık Kırmızı Orijinal Kartuş",
    },
    compatibleModels: COMPATIBLE_MODELS,
  },
  {
    title: "EPSON T6367 (C13T636700) Açık Siyah Orijinal Kartuş",
    code: "T6367",
    colorLabel: "Açık Siyah (Light Black)",
    capacity: "700 ml",
    image: {
      src: "/images/urunler/kartus/epson-orijinal-kartus/epson-t6367-c13t636700-acik-siyah-orijinal-kartus.jpg",
      alt: "EPSON T6367 (C13T636700) Açık Siyah Orijinal Kartuş",
    },
    compatibleModels: COMPATIBLE_MODELS,
    notes: ["Kod karşılığı: C13T636700"],
  },
  {
    title: "EPSON T636A (C13T636A00) Orijinal Turuncu Kartuş",
    code: "T636A",
    colorLabel: "Turuncu (Orange)",
    capacity: "700 ml",
    image: {
      src: "/images/urunler/kartus/epson-orijinal-kartus/epson-t636a-c13t636a00-orijinal-turuncu-kartus.jpg",
      alt: "EPSON T636A (C13T636A00) Orijinal Turuncu Kartuş",
    },
    compatibleModels: COMPATIBLE_MODELS,
    notes: ["Kod karşılığı: C13T636A00"],
  },
  {
    title: "EPSON T636B (C13T636B00) Orijinal Yeşil Kartuş",
    code: "T636B",
    colorLabel: "Yeşil (Green)",
    capacity: "700 ml",
    image: {
      src: "/images/urunler/kartus/epson-orijinal-kartus/epson-t636b-c13t636b00-orijinal-yesil-kartus.jpg",
      alt: "EPSON T636B (C13T636B00) Orijinal Yeşil Kartuş",
    },
    compatibleModels: COMPATIBLE_MODELS,
    notes: ["Kod karşılığı: C13T636B00"],
  },
];
...
export default function EpsonT636Client() {
      ...
      <div className="mt-10 grid gap-6 lg:grid-cols-3">
        ...
        <div className="rounded-xl border border-slate-200 bg-white p-5">
          ...
          <div className="mt-4 grid gap-3">
            ...
            <InfoRow label="Seri" value="Epson T636" />
