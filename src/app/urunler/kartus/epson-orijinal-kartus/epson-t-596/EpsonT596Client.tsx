// src/app/urunler/kartus/epson-orijinal-kartus/epson-t-596/EpsonT596Client.tsx
"use client";
...
const ITEMS: EpsonT596Item[] = [
  {
    title: "EPSON T596C White (Beyaz) KARTUŞ",
    code: "T596C",
    colorLabel: "White (Beyaz)",
    capacity: "700 ml",
    image: {
      src: "/images/urunler/kartus/epson-orijinal-kartus/epson-t596c-white-beyaz-kartus.jpg",
      alt: "EPSON T596C White (Beyaz) Kartuş",
    },
    compatibleModels: [
...
export default function EpsonT596Client() {
      ...
      <div className="mt-10 grid gap-6 lg:grid-cols-3">
        ...
        <div className="rounded-xl border border-slate-200 bg-white p-5">
          ...
          <div className="mt-4 grid gap-3">
            ...
            <InfoRow label="Seri" value="Epson T596" />
