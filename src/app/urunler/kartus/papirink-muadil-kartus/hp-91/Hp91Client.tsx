// src/app/urunler/kartus/papirink-muadil-kartus/hp-91/Hp91Client.tsx
"use client";
...
const COMPATIBLE_MODELS = ["HP DesignJet Z6100"];
...
export default function Hp91Client() {
  ...
  const rightColorLabel = selectedColor;
          ...
          {ITEMS.map((it) => {
            ...
            return (
              <button
                ...
                className={cx(
                  "rounded-lg border px-4 py-3 text-left transition min-w-[180px]",
                  isActive
      ...
      <div className="mt-10 grid gap-6 lg:grid-cols-3">
        ...
        <div className="rounded-xl border border-slate-200 bg-white p-5">
          ...
          <div className="mt-4 grid gap-3">
            ...
            <InfoRow label="Seri" value="HP 91" />
        ...
        <div className="rounded-xl border border-slate-200 bg-white p-5">
          ...
          <div className="mt-4 rounded-xl border border-slate-200 bg-white">
            <div className="grid grid-cols-1 divide-y divide-slate-200">
              <BoxRow label="Ürün Adı" value="HP 91 Muadil Plotter Kartuşu" />
              <BoxRow label="Marka" value="HP - DesignJet Z6100" />
          ...
          <p className="mt-4 text-xs text-slate-500">
            * Seçtiğiniz renk:{" "}
            <span className="font-semibold">{rightColorLabel}</span>
          </p>
        </div>
      </div>
      ...
      {openSrc && (
        ...
        >
          <div className="mx-auto h-full w-full max-w-6xl">
            ...
            >
              {/* Kapat butonu: görünür garanti */}
              <button
                type="button"
                onClick={() => setOpenSrc(null)}
                className="absolute right-3 top-3 z-20 rounded-full bg-white/95 px-4 py-2 text-sm font-bold text-slate-900 shadow-lg ring-1 ring-black/10 hover:bg-white"
                aria-label="Kapat"
              >
                ✕
              </button>
