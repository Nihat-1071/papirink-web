// src/app/urunler/kartus/papirink-muadil-kartus/hp-761/Hp761Client.tsx
"use client";
...
type Hp761Item = {
  ...
  notes?: string[];
  colorOptions?: Array<{ value: string; label: string }>; // sadece "Tüm Renkler" için
};

const COMPATIBLE_MODELS = ["HP DesignJet T7100", "HP DesignJet T7200"];
...
const ITEMS: Hp761Item[] = [
  ...
  },
  {
    ...
    notes: [
      "Not: Siyah renk 775 ml olup fiyatı farklıdır. Papirink Kartuş kısmından Siyah renk fiyatına bakabilirsiniz.",
    ],
  },
];
...
export default function Hp761Client() {
  ...
  const rightColorLabel =
    active.code === "TÜM-RENKLER" ? selectedColor : active.colorLabel;
    ...
    <>
            ...
            return (
              ...
              >
                <div className="text-sm font-semibold leading-none">
                  {it.code === "SİYAH" ? "Siyah" : "Tüm Renkler"}
                </div>
      ...
      <div className="mt-10 grid gap-6 lg:grid-cols-3">
        ...
        <div className="rounded-xl border border-slate-200 bg-white p-5">
          ...
          <div className={cx("grid gap-3", active.code === "TÜM-RENKLER" ? "mt-4" : "mt-4")}>
            <InfoRow label="Marka" value="Papirink" />
            <InfoRow label="Kategori" value="Muadil Kartuş" />
            <InfoRow label="Seri" value="HP 761" />
        ...
        <div className="rounded-xl border border-slate-200 bg-white p-5">
          ...
          <div className="mt-4 rounded-xl border border-slate-200 bg-white">
            <div className="grid grid-cols-1 divide-y divide-slate-200">
              <BoxRow label="Ürün Adı" value="HP 761 Muadil Plotter Kartuşu" />
              <BoxRow label="Marka" value="HP - DesignJet T7100 - T7200" />
          ...
          {active.code === "TÜM-RENKLER" ? (
            ...
            <p className="mt-4 text-xs text-slate-500">
              * Sipariş/teklif öncesi yazıcı modelinizi paylaşın, birlikte doğrulayalım.
            </p>
          )}
        </div>
      </div>
      ...
      {openSrc && (
        ...
        >
          <div className="mx-auto h-full w-full max-w-6xl">
            ...
            type="button"
            onClick={() => setOpenSrc(null)}
            className="fixed right-6 top-6 z-[999] rounded-full bg-white px-4 py-2 text-sm font-bold text-slate-900 shadow-lg ring-1 ring-black/10 hover:bg-slate-100"
            aria-label="Kapat"
            >
            ✕
            </button>
