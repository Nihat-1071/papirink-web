...
const COMPATIBLE_MODELS = ["HP DesignJet Z6200"];

// HP 771 için yaygın renk seçenekleri (Z6200 / 771 ekosistemi)
// İstersen listeyi aynen kullan; sonra senin katalog renklerine göre daraltırız.
const ALL_COLORS = [
  ...
  { value: "Kromatik Kırmızı (Chromatic Red)", label: "Kromatik Kırmızı ( Chromatic Red )" },
  { value: "Kromatik Yeşil (Chromatic Green)", label: "Kromatik Yeşil ( Chromatic Green )" },
];
      ...
      <div className="mt-10 grid gap-6 lg:grid-cols-3">
        ...
        <div className="rounded-xl border border-slate-200 bg-white p-5">
          ...
          <div className="mt-4 grid gap-3">
            ...
            <InfoRow label="Seri" value="HP 771" />
        ...
        <div className="rounded-xl border border-slate-200 bg-white p-5">
          ...
          <div className="mt-4 rounded-xl border border-slate-200 bg-white">
            <div className="grid grid-cols-1 divide-y divide-slate-200">
              <BoxRow label="Ürün Adı" value="HP 771C Muadil Kartuşu Tüm Renkler" />
              <BoxRow label="Marka" value="HP - DesignJet Z6200" />
