...
const COMPATIBLE_MODELS_CANON707: string[] = [
  "Canon imagePROGRAF iPF830",
  "Canon imagePROGRAF iPF840",
  "Canon imagePROGRAF iPF850",
];

const ITEMS: Canon707Item[] = [
  {
    title: "Canon PFI-707MBK Mat Siyah Orijinal Kartuş - iPF830 / iPF840 / iPF850",
    code: "PFI-707MBK",
    colorLabel: "Mat Siyah (Matte Black / MBK)",
    capacity: "700 ml",
    image: {
      src: "/images/urunler/kartus/canon-orijinal-kartus/canon-pfi-707mbk-siyah-orijinal-kartus-ipf830-ipf840-ipf850.jpg",
      alt: "Canon PFI-707MBK Mat Siyah Orijinal Kartuş - iPF830 / iPF840 / iPF850",
    },
    compatibleModels: COMPATIBLE_MODELS_CANON707,
  },
];
...
export default function CanonPfi707Client() {
      ...
      <div className="mt-10 grid gap-6 lg:grid-cols-3">
        ...
        <div className="rounded-xl border border-slate-200 bg-white p-5">
          ...
          <div className="mt-4 grid gap-3">
            ...
            <InfoRow label="Seri" value="Canon PFI-707" />
