// src/app/urunler/kartus/canon-orijinal-kartus/canon-1700/Canon1700Client.tsx
"use client";
...
type Canon1700Item = {
  title: string;
  code: string; // PFI-1700C/0776C001 vb.
  colorLabel: string;
  capacity: string; // 700 ml.
  image: { src: string; alt: string };
  compatibleModels: string[];
  notes?: string[];
};

const COMPATIBLE_MODELS_CANON1700: string[] = [
...
const IMG_BASE =
  "/images/urunler/kartus/canon-orijinal-kartus";

const ITEMS: Canon1700Item[] = [
  {
    title: "Canon PFI-1700C/0776C001 Mavi Orijinal Kartuş",
    code: "PFI-1700C / 0776C001",
    ...
    compatibleModels: COMPATIBLE_MODELS_CANON1700,
  },
  {
    title: "Canon PFI-1700GY/0781C001 Gri Orijinal Kartuş",
    code: "PFI-1700GY / 0781C001",
  ...
  {
    title: "Canon PFI-1700M/0777C001 Kırmızı Orijinal Kartuş",
    code: "PFI-1700M / 0777C001",
  ...
  {
    title: "Canon PFI-1700MBK/0774C001 Mat Siyah Orijinal Kartuş",
    code: "PFI-1700MBK / 0774C001",
  ...
  {
    title: "Canon PFI-1700PBK/0775C001 Foto Siyah Orijinal Kartuş",
    code: "PFI-1700PBK / 0775C001",
    colorLabel: "Foto Siyah (Photo Black / PBK)",
    capacity: "700 ml",
    image: {
  ...
  {
    title: "Canon PFI-1700PC/0779C001 Foto Mavi Orijinal Kartuş",
    code: "PFI-1700PC / 0779C001",
  ...
  {
    title: "Canon PFI-1700PM/0780C001 Foto Kırmızı Orijinal Kartuş",
    code: "PFI-1700PM / 0780C001",
  ...
  {
    title: "Canon PFI-1700Y/0778C001 Sarı Orijinal Kartuş",
    code: "PFI-1700Y / 0778C001",
...
export default function Canon1700Client() {
          ...
          {ITEMS.map((it) => {
            ...
            return (
              <button
                ...
                className={cx(
                  "rounded-lg border px-4 py-3 text-left transition min-w-[170px]",
                  isActive
      ...
      <div className="mt-10 grid gap-6 lg:grid-cols-3">
        ...
        <div className="rounded-xl border border-slate-200 bg-white p-5">
          ...
          <div className="mt-4 grid gap-3">
            ...
            <InfoRow label="Seri" value="Canon PFI-1700" />
