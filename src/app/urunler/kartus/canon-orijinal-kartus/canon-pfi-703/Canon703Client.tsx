...
type Canon703Item = {
  title: string;
  code: string; // butonlarda görünecek kod
  colorLabel: string;
  capacity: string;
...
const COMPATIBLE_MODELS_CANON703: string[] = [
...
const ITEMS: Canon703Item[] = [
  {
    title: "Canon PFI-703 Mavi Plotter Kartuş",
    code: "PFI-703C",
    colorLabel: "Mavi (Cyan / C)",
    capacity: "700 ml",
    image: {
      src: "/images/urunler/kartus/canon-orijinal-kartus/canon-pfi-703-mavi-kartus.jpg",
      alt: "Canon PFI-703 Mavi Plotter Kartuş",
    },
    compatibleModels: COMPATIBLE_MODELS_CANON703,
  },
  {
    title: "Canon PFI-703 Kırmızı Plotter Kartuş",
    code: "PFI-703M",
    colorLabel: "Kırmızı (Magenta / M)",
    capacity: "700 ml",
    image: {
      src: "/images/urunler/kartus/canon-orijinal-kartus/canon-pfi-703y-kirmizi-kartus.jpg",
      alt: "Canon PFI-703 Kırmızı Plotter Kartuş",
    },
    compatibleModels: COMPATIBLE_MODELS_CANON703,
  },
  {
    title: "Canon PFI-703 Mat Siyah Plotter Kartuş",
    code: "PFI-703MBK",
    colorLabel: "Mat Siyah (Matte Black / MBK)",
    capacity: "700 ml",
    image: {
      src: "/images/urunler/kartus/canon-orijinal-kartus/canon-pfi-703y-mat-siyah-kartus.jpg",
      alt: "Canon PFI-703 Mat Siyah Plotter Kartuş",
    },
    compatibleModels: COMPATIBLE_MODELS_CANON703,
  },
  {
    title: "Canon PFI-703 Sarı Plotter Kartuş",
    code: "PFI-703Y",
    colorLabel: "Sarı (Yellow / Y)",
    capacity: "700 ml",
    image: {
      src: "/images/urunler/kartus/canon-orijinal-kartus/canon-pfi-703y-sari-kartus.jpg",
      alt: "Canon PFI-703 Sarı Plotter Kartuş",
    },
    compatibleModels: COMPATIBLE_MODELS_CANON703,
  },
  {
    title: "Canon PFI-703 Siyah Plotter Kartuş",
    code: "PFI-703BK",
    colorLabel: "Siyah (Black / BK)",
    capacity: "700 ml",
    image: {
      src: "/images/urunler/kartus/canon-orijinal-kartus/canon-pfi-703y-siyah-kartus.jpg",
      alt: "Canon PFI-703 Siyah Plotter Kartuş",
    },
    compatibleModels: COMPATIBLE_MODELS_CANON703,
  },
];
...
export default function Canon703Client() {
      ...
      <div className="mt-10 grid gap-6 lg:grid-cols-3">
        ...
        <div className="rounded-xl border border-slate-200 bg-white p-5">
          ...
          <div className="mt-4 grid gap-3">
            ...
            <InfoRow label="Seri" value="Canon PFI-703" />
