// src/app/urunler/kartus/canon-orijinal-kartus/canon-pfi-102/CanonPfi102Client.tsx
"use client";
...
const COMPATIBLE_MODELS_CANON_PFI102: string[] = [
...
const ITEMS: CanonPfi102Item[] = [
  {
    title: "Canon PFI-102BK Parlak Siyah Kartuş - iPF500 / iPF600",
    code: "PFI-102BK",
    colorLabel: "Parlak Siyah (Black)",
    capacity: "130 ml",
    image: {
      src: "/images/urunler/kartus/canon-orijinal-kartus/canon-pfi-102bk-parlak-siyah-kartus-ipf500-ipf600.jpg",
      alt: "Canon PFI-102BK Parlak Siyah Kartuş - iPF500 / iPF600",
    },
    compatibleModels: COMPATIBLE_MODELS_CANON_PFI102,
  },
  {
    title: "Canon PFI-102MBK Mat Siyah Kartuş - iPF500 / iPF600",
    code: "PFI-102MBK",
    colorLabel: "Mat Siyah (Matte Black)",
    capacity: "130 ml",
    image: {
      src: "/images/urunler/kartus/canon-orijinal-kartus/canon-pfi-102mbk-mat-siyah-kartus-ipf500-ipf600.jpg",
      alt: "Canon PFI-102MBK Mat Siyah Kartuş - iPF500 / iPF600",
    },
    compatibleModels: COMPATIBLE_MODELS_CANON_PFI102,
  },
  {
    title: "Canon PFI-102C Mavi Orijinal Kartuş - iPF500 / iPF600",
    code: "PFI-102C",
    colorLabel: "Mavi (Cyan)",
    capacity: "130 ml",
    image: {
      src: "/images/urunler/kartus/canon-orijinal-kartus/canon-pfi-102c-mavi-orijinal-kartus-ipf500-ipf600.jpg",
      alt: "Canon PFI-102C Mavi Orijinal Kartuş - iPF500 / iPF600",
    },
    compatibleModels: COMPATIBLE_MODELS_CANON_PFI102,
  },
  {
    title: "Canon PFI-102M Kırmızı Orijinal Kartuş - iPF500 / iPF600",
    code: "PFI-102M",
    colorLabel: "Kırmızı (Magenta)",
    capacity: "130 ml",
    image: {
      src: "/images/urunler/kartus/canon-orijinal-kartus/canon-pfi-102m-kirmizi-orijinal-kartus-ipf500-ipf600.jpg",
      alt: "Canon PFI-102M Kırmızı Orijinal Kartuş - iPF500 / iPF600",
    },
    compatibleModels: COMPATIBLE_MODELS_CANON_PFI102,
  },
  {
    title: "Canon PFI-102Y Sarı Orijinal Kartuş - iPF500 / iPF600",
    code: "PFI-102Y",
    colorLabel: "Sarı (Yellow)",
    capacity: "130 ml",
    image: {
      src: "/images/urunler/kartus/canon-orijinal-kartus/canon-pfi-102y-sari-orijinal-kartus-ipf500-ipf600.jpg",
...
export default function CanonPfi102Client() {
      ...
      <div className="mt-10 grid gap-6 lg:grid-cols-3">
        ...
        <div className="rounded-xl border border-slate-200 bg-white p-5">
          ...
          <div className="mt-4 grid gap-3">
            ...
            <InfoRow label="Seri" value="Canon PFI-102" />
        ...
        <div className="rounded-xl border border-slate-200 bg-white p-5">
          ...
          <div className="mt-4 rounded-xl border border-slate-200 bg-white">
            <div className="grid grid-cols-1 divide-y divide-slate-200">
              ...
              <BoxRow label="Marka" value="Canon" />
